...
class EvidenceRelationshipsActivity : AppCompatActivity() {
    ...
    private fun globalHeader(total: Int) = LinearLayout(this).apply {
        ...
        addView(TextView(this@EvidenceRelationshipsActivity).apply { text = "RELATIONSHIP COMMAND"; textSize = 26f; setTextColor(text); setTypeface(null, Typeface.BOLD); setPadding(0, dp(4), 0, dp(2)) })
    ...
    private fun header(person: PersonEntity, images: Int, faces: Int) = LinearLayout(this).apply {
        ...
        addView(TextView(this@EvidenceRelationshipsActivity).apply { text = person.displayName?.takeIf { it.isNotBlank() } ?: "UNKNOWN SUBJECT"; textSize = 26f; setTextColor(text); setTypeface(null, Typeface.BOLD); setPadding(0, dp(4), 0, dp(2)) })
    ...
    private fun objectCard(label: String, count: Int) = LinearLayout(this).apply {
        ...
        addView(TextView(this@EvidenceRelationshipsActivity).apply { text = "◆  $label"; textSize = 11f; setTextColor(text); setTypeface(null, Typeface.BOLD) }, LinearLayout.LayoutParams(0, -2, 1f))
    ...
    private fun evidenceLinkCard(sequence: Int, image: ImageEntity, faceCount: Int): View {
        ...
        info.addView(TextView(this@EvidenceRelationshipsActivity).apply { text = image.fileName; textSize = 12f; setTextColor(text); setTypeface(null, Typeface.BOLD); setPadding(0, dp(5), 0, dp(4)); maxLines = 2 })
