...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private val MIGRATION_2_3 = object : Migration(2, 3) { override fun migrate(database: SupportSQLiteDatabase) { database.execSQL("""CREATE TABLE IF NOT EXISTS persons (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, displayName TEXT, description TEXT, faceCount INTEGER NOT NULL DEFAULT 0, bestQualityScore REAL NOT NULL DEFAULT 0.0, hasRepresentativeEmbedding INTEGER NOT NULL DEFAULT 0, representativeFaceId INTEGER, createdAt INTEGER NOT NULL, updatedAt INTEGER NOT NULL, modelVersion TEXT NOT NULL DEFAULT '1.0', isFavorite INTEGER NOT NULL DEFAULT 0, isArchived INTEGER NOT NULL DEFAULT 0)"""); database.execSQL("CREATE INDEX IF NOT EXISTS index_persons_displayName ON persons(displayName)"); database.execSQL("CREATE INDEX IF NOT EXISTS index_persons_createdAt ON persons(createdAt)"); database.execSQL("CREATE INDEX IF NOT EXISTS index_persons_updatedAt ON persons(updatedAt)"); database.execSQL("""CREATE TABLE IF NOT EXISTS faces (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, imageId INTEGER NOT NULL, personId INTEGER, boundingLeft REAL NOT NULL, boundingTop REAL NOT NULL, boundingRight REAL NOT NULL, boundingBottom REAL NOT NULL, detectionConfidence REAL NOT NULL, qualityScore REAL NOT NULL, rotationX REAL, rotationY REAL, rotationZ REAL, hasEmbedding INTEGER NOT NULL DEFAULT 0, hasLandmarks INTEGER NOT NULL DEFAULT 0, landmarkCount INTEGER NOT NULL DEFAULT 0, isOccluded INTEGER NOT NULL DEFAULT 0, usableForMatching INTEGER NOT NULL DEFAULT 0, analyzedAt INTEGER NOT NULL, analyzerVersion TEXT NOT NULL DEFAULT '1.0', FOREIGN KEY(imageId) REFERENCES images(id) ON DELETE CASCADE, FOREIGN KEY(personId) REFERENCES persons(id) ON DELETE SET NULL)"""); database.execSQL("CREATE INDEX IF NOT EXISTS index_faces_imageId ON faces(imageId)"); database.execSQL("CREATE INDEX IF NOT EXISTS index_faces_personId ON faces(personId)"); database.execSQL("CREATE INDEX IF NOT EXISTS index_faces_qualityScore ON faces(qualityScore)"); database.execSQL("""CREATE TABLE IF NOT EXISTS embeddings (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, ownerType TEXT NOT NULL, ownerId INTEGER NOT NULL, vector BLOB NOT NULL, dimension INTEGER NOT NULL, modelName TEXT NOT NULL, modelVersion TEXT NOT NULL, normalized INTEGER NOT NULL DEFAULT 1, createdAt INTEGER NOT NULL)"""); database.execSQL("CREATE INDEX IF NOT EXISTS index_embeddings_ownerType_ownerId ON embeddings(ownerType, ownerId)"); database.execSQL("CREATE INDEX IF NOT EXISTS index_embeddings_modelName_modelVersion ON embeddings(modelName, modelVersion)"); database.execSQL("CREATE INDEX IF NOT EXISTS index_embeddings_dimension ON embeddings(dimension)") } }
        ...
        private val MIGRATION_10_11 = object : Migration(10, 11) { override fun migrate(database: SupportSQLiteDatabase) { database.execSQL("""CREATE TABLE IF NOT EXISTS visual_index_operations (id TEXT NOT NULL PRIMARY KEY, rebuild INTEGER NOT NULL, total INTEGER NOT NULL, processed INTEGER NOT NULL, indexed INTEGER NOT NULL, skipped INTEGER NOT NULL, failed INTEGER NOT NULL, localFeatures INTEGER NOT NULL, status TEXT NOT NULL, engineHaar TEXT NOT NULL, engineClassical TEXT NOT NULL, engineAdvanced TEXT NOT NULL, startedAt INTEGER NOT NULL, updatedAt INTEGER NOT NULL, finishedAt INTEGER, lastError TEXT)"""); database.execSQL("CREATE INDEX IF NOT EXISTS index_visual_index_operations_status ON visual_index_operations(status)"); database.execSQL("CREATE INDEX IF NOT EXISTS index_visual_index_operations_updatedAt ON visual_index_operations(updatedAt)") } }
        private val MIGRATION_11_12 = object : Migration(11, 12) {
            override fun migrate(database: SupportSQLiteDatabase) {
                database.execSQL("DROP TABLE IF EXISTS advanced_visual_fingerprints")
                database.execSQL("""CREATE TABLE IF NOT EXISTS advanced_visual_fingerprints (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, itemId INTEGER NOT NULL, engineVersion TEXT NOT NULL, grayPyramid BLOB NOT NULL, colorMoments BLOB NOT NULL, spatialColor BLOB NOT NULL, lbpHistogram BLOB NOT NULL, spatialLbp BLOB NOT NULL, gradientHistogram BLOB NOT NULL, gradientMagnitude BLOB NOT NULL, layoutSignature BLOB NOT NULL, illuminationRobustStructure BLOB NOT NULL, entropy REAL NOT NULL, aspectRatio REAL NOT NULL, createdAt INTEGER NOT NULL)""")
